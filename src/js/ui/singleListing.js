...
export async function displaySingleListing() {
  ...
  try {
    ...
    // Sort bids in order of highest to lowest
    const sortedBids = listing.bids?.length
    ...
    const bidFormHTML = `
        <div class="bid-form-container mt-6">
          <p class="mb-2"><strong>Høyeste bud:</strong> ${highestBidAmount} NOK</p>
